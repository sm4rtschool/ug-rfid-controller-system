...
class Handheldmodel extends CI_Model {
    ...
    public function count_all_content($filter_id_parameter){
        ...
        $this->db->select('a.*, b.kode_brg, b.nup, b.nama_brg');
        $this->db->from('tag_temp_table a');
        $this->db->join('tb_asset_master b', 'a.rfid_tag_number = b.tag_code');
    ...
    public function get_content($limit, $start, $order, $dir, $filter_id_parameter){
        ...
        $ssql = "SELECT a.*, b.kode_brg, b.nup, b.nama_brg 
                FROM tag_temp_table a 
                JOIN tb_asset_master b ON a.rfid_tag_number = b.tag_code ";
    ...
    public function content_search($limit, $start, $search, $order, $dir){
        ...
        $this->db->like('b.nama_brg', $search);
        $this->db->or_like('b.kode_brg', $search);
